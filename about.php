                ...
                <div class="col-lg-8">
                    <nav class="header__menu">
                        <ul>
                            ...
                            <li><a href="./saleproduct.php">Đơn hàng</a></li>
        ...
        <div class="member">
            <div class="container">
                ...
                <div class="slick-image">
                    <div>
                        <img src="./img/members/Thu.png" alt="Avatar" class="member-image">
                        <h4>Lê Anh Thư</h4>
                        <h5>Project Leader</h5>
                    </div>

                    <div>
                        <img src="./img/members/Thien.png" alt="Avatar" class="member-image">
                        <h4>Huỳnh Đức Thiện</h4>
                        <h5>Developer</h5>
                    </div>

                    <div>
                        <img src="./img/members/An.png" alt="Avatar" class="member-image">
                        <h4>Phan Thanh An</h4>
                        <h5>Developer</h5>
                    </div>

                    <div>
                        <img src="./img/members/Phuc.png" alt="Avatar" class="member-image">
                        <h4>Châu Hoàng Bảo Phúc</h4>
                        <h5>Developer</h5>
                    </div>

                    <div>
                        <img src="./img/members/Bao.png" alt="Avatar" class="member-image">
